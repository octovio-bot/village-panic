import { getTinySwordsAnimationDef, getTinySwordsAssetDef } from './assets/manifestRegistry.js';
...
export const TINY_SWORDS_ASSETS = [
  ...
  image('tinyswords.ui.smallbar.base', `${ASSET_BASE}/UI Elements/UI Elements/Bars/SmallBar_Base.png`),
  image('tinyswords.ui.smallbar.fill', `${ASSET_BASE}/UI Elements/UI Elements/Bars/SmallBar_Fill.png`),
  sheet('tinyswords.ui.bigbar.base.frame', `${ASSET_BASE}/UI Elements/UI Elements/Bars/BigBar_Base.png`, UI_BAR_BASE),
  sheet('tinyswords.ui.smallbar.base.frame', `${ASSET_BASE}/UI Elements/UI Elements/Bars/SmallBar_Base.png`, UI_BAR_BASE),
...
export function createTinySwordsAnimations(scene) {
  ...
  const sheetVariantAnimations = [
    ...
    getTinySwordsAnimationDef('tree1-wind'),
    getTinySwordsAnimationDef('tree2-wind'),
    getTinySwordsAnimationDef('tree3-wind'),
    getTinySwordsAnimationDef('tree4-wind')
  ];
